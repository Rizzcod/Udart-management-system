<x-app-layout title="My Assigned Work Orders">
    @php
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="fw-bold mb-0" style="color:#111827;">My Assigned Work Orders</h4>
            <nav aria-label="breadcrumb" class="mt-1">
                <ol class="breadcrumb mb-0" style="font-size:.8rem;">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}" style="color:#1c3faa;"><i class="bi bi-house-door"></i></a></li>
                    <li class="breadcrumb-item active text-muted">My Assignments</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="row g-2 align-items-end">
                    <div class="col-lg-3">
                        ...
                        <select name="status" class="form-select" style="border-radius:9px;">
                            ...
                            @foreach(['pending','assigned','awaiting_parts','in_progress','testing','completed','returned_to_service','cancelled'] as $s)
                    ...
                    <div class="col-auto d-flex gap-2">
                        ...
                        <a href="{{ route('work-orders.my-assignments') }}" class="btn btn-outline-secondary d-flex align-items-center gap-1" style="border-radius:9px;font-size:.875rem;">
        ...
        <div class="table-responsive">
            <table class="table mb-0">
                <thead><tr>
                    ...
                    <th class="py-3" style="font-size:.72rem;font-weight:700;text-transform:uppercase;color:#9ca3af;">Date</th>
                ...
                <tbody>
                    ...
                    <tr class="wo-row" style="border-bottom:1px solid #f9fafb;">
                        ...
                        <td class="py-3 text-muted" style="font-size:.82rem;">{{ $wo->created_at->format('d M Y') }}</td>
                        <td class="py-3 pe-4">
                            <a href="{{ route('work-orders.show', $wo) }}" title="View" class="btn btn-sm btn-outline-primary" style="border-radius:7px;font-size:.75rem;">
                                Open
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr><td colspan="8" class="text-center py-5 text-muted">
                        <i class="bi bi-check2-all d-block" style="font-size:2.5rem;opacity:.2;"></i>
                        <div class="mt-2">No work orders assigned to you.</div>
                    </td></tr>
                    @endforelse
                </tbody>
            </table>
